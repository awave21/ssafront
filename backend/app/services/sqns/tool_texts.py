...
SQNS_TOOL_DESCRIPTIONS: dict[str, str] = {
    "sqns_find_booking_options": (
        ...
        "Если вместе с category название услуги не попало в поиск, ответ всё равно может содержать alternatives.services — услуги только по категории (уточни название и перезапроси). "
