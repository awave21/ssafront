<template>
  <div class="space-y-4">
    <div class="flex items-center justify-between">
      <h3 class="text-sm font-bold uppercase tracking-widest text-slate-400">Итоги по товарам</h3>
    </div>
...
import type { AnalyticsCommoditiesTableTotals } from '~/types/analytics'
...
const summaryCards = computed(() => [
  {
    id: 'commodities_total',
    title: 'Товаров',
    value: formatInt(props.totals.commodities_total),
  ...
  },
  {
    ...
    description: 'Всего записей с товаром в визите',
    icon: CalendarCheck
  },
  {
    id: 'arrived_total',
  ...
  },
  {
    ...
    description: 'Суммарная выручка по товарам',
    icon: Wallet
  },
  {
    id: 'avg_check',
