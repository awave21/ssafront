<template>
  <AgentPageShell title="Навыки эксперта" :hide-actions="true" :contained="true">
    <div class="max-w-full space-y-6">
      ...
      <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div class="flex flex-wrap items-center gap-2">
          <button
            type="button"
            class="inline-flex h-10 shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-xl bg-indigo-600 px-4 text-sm font-bold text-white transition-colors hover:bg-indigo-700 disabled:opacity-50"
            :disabled="creating"
            @click="handleCreate"
          >
            <Plus class="h-4 w-4" />
      ...
      >
        <div class="mx-auto max-w-md">
          <div class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-indigo-50">
            <Sparkles class="h-8 w-8 text-indigo-400" />
          </div>
        ...
        >
          ...
          <div class="flex items-start justify-between gap-3">
            <div class="flex min-w-0 flex-1 items-start gap-3">
              <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-indigo-50 transition-colors group-hover:bg-indigo-100">
              ...
              <div class="min-w-0 flex-1">
                ...
                <div class="mt-1.5 flex flex-wrap items-center gap-1">
                  <span
                    ...
                    :key="name"
                    class="inline-flex max-w-[180px] items-center gap-1 rounded-2xl bg-indigo-50/70 px-2 py-0.5 text-[11px] font-medium text-indigo-700"
                  >
          ...
          <div class="mt-4 grid grid-cols-3 gap-2">
            ...
            <div class="rounded-2xl bg-indigo-50/60 px-3 py-2.5">
              <div class="text-[9px] font-black uppercase tracking-wider text-indigo-600/80">Покрытие</div>
              <div class="mt-0.5 text-lg font-bold text-indigo-700">
        ...
        <div class="max-h-[60vh] overflow-y-auto p-4">
          ...
          <div v-else class="space-y-2">
            ...
            >
              ...
              <button
                type="button"
                class="inline-flex shrink-0 items-center gap-1 rounded-lg border border-indigo-200 bg-indigo-50 px-2.5 py-1.5 text-xs font-medium text-indigo-700 transition-colors hover:bg-indigo-100"
