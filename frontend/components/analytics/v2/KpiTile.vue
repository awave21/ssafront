<template>
  <div
    class="group relative overflow-hidden rounded-3xl border border-slate-100 bg-white p-6 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.04)] transition-all hover:-translate-y-0.5 hover:shadow-[0_20px_40px_-12px_rgba(0,0,0,0.08)] duration-500"
    :class="accentBg"
  >
    ...
    <div class="relative flex items-start justify-between gap-3">
      <div class="min-w-0 flex-1">
        ...
        <div v-if="sub" class="mt-1 text-xs text-slate-400">{{ sub }}</div>
      </div>
