<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h3 class="text-sm font-bold uppercase tracking-widest text-slate-400">Топ услуги по записям</h3>
          ...
          <div class="mb-5 flex items-start justify-between">
            <div class="flex flex-col gap-1">
              ...
              <span class="text-[11px] font-medium text-slate-400">
                {{ service.service_category || 'Без категории' }}
              </span>
            </div>
    ...
    >
      ...
      <p class="text-sm font-medium text-slate-500">Нет данных для формирования топа услуг</p>
